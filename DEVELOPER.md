...
* `REACT_APP_LOCALE`: The default locale for ui, seeded at runtime via the envs API (the ui is a single bundle with all locales), e.g. `zh`, `en` or `ja`, default to `zh`.
